...
<%
    _MenJeansFeatures menJeansFeatures = (_MenJeansFeatures) request.getAttribute("menJeansFeatures");
			...
			<form method="post" enctype="multipart/form-data" id="form8"> 
				...
				<h3>Advance Features</h3>
					<div class="row">					
						...
						<% if (menJeansFeatures == null) { %>
						<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="fabric" class="form-control" required placeholder="100% Cotton" />
						</div>
						<% } else { %>
						<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="fabric" class="form-control" required value="<%=menJeansFeatures.getFabric() %>" />
						</div>
						<% } %>
						...
						<% if (menJeansFeatures == null) { %>
						<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="brandFit" class="form-control" required placeholder="Regular Straight Fit" />
						</div>
						<% } else { %>
						<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="brandFit" class="form-control" required value="<%=menJeansFeatures.getBrandFit() %>" />
						</div>
						<% } %>							
					</div>
					...
					<div class="row">	
						...
						<% if (menJeansFeatures == null) { %>
						<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="pattern" class="form-control" required placeholder="Solid"/> </div>
						<% } else { %>
						<div class="col-md-3 col-sm-6 col-xs-12">
						    <input type="text" name="pattern" class="form-control" required value="<%=menJeansFeatures.getPattern() %>" /></div>
						<% } %>								
						...
						<% if (menJeansFeatures == null) { %>
						<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="pockets" class="form-control" required placeholder="1 Coin Pocket at Front, 2 Curved Pockets at Front, 2 Patch Pockets at Back"/> </div>
						<% } else { %>
						<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="pockets" class="form-control" required value="<%=menJeansFeatures.getPockets() %>" /> </div>
						<% } %>	
					</div>							
					...
					<div class="row">
						<div class="col-md-3 col-sm-6 col-xs-12">	
							<label> BeltLoops </label>
						</div>
						<% if (menJeansFeatures == null) { %>
						<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="beltLoops" class="form-control" required placeholder="Yes" /> </div>
						<% } else { %>
						<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="beltLoops" class="form-control" required value="<%=menJeansFeatures.getBeltLoops() %>" /> </div>
						<% } %>								
						...
						<% } else { %>
						<div class="col-md-3 col-sm-6 col-xs-12"> 
							<input type="text" name="occasion" class="form-control" required value="<%=menJeansFeatures.getOccasion() %>" /> </div>
						<% } %>							
					</div>

<%@page import="ecom.model.product.features.Television"%>
...
<title>Television Edit Page</title>
...
<section id="2">	
	...
	<div id="invisible" style="display:none;">
		<div id="advanceFeatures" style="width:100%;">
			<form method="post" enctype="multipart/form-data" id="form12"> 
				...
				<h3>Advance Features</h3>
					<div class="row">					
						...
						<label> Display Size </label>
							...
							<% if (television == null) { %>
							<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="displaySize" class="form-control" required placeholder="102 cm (40)" /></div>
							<% } else { %>
							<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="displaySize" class="form-control" required value="<%=television.getDisplaySize() %>" />
							</div>
							<% } %>
						...
						<label> Screen Type </label>
							...
							<% if (television == null) { %>
							<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="screenType" class="form-control" required placeholder="LED" />
							</div>
							<% } else { %>
							<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="screenType" class="form-control" required value="<%=television.getScreenType() %>" />
							</div>
							<% } %>							
					      </div>
					...
					<div class="col-md-3 col-sm-6 col-xs-12">
							...
							<% if (television == null) { %>
							<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" class="form-control" name="hdmi" required placeholder="2"/> </div>
							<% } else { %>
							<div class="col-md-3 col-sm-6 col-xs-12">
								<input type="text" class="form-control" name="hdmi" required value="<%=television.getHdmi() %>" /></div>
							<% } %>								

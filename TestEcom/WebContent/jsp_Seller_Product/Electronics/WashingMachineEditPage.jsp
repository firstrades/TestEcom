<%@page import="ecom.model.product.features.WashingMachine"%>
...
<title>Washing Machine Edit Page</title>
...
<%
	WashingMachine washingMachine = (WashingMachine) request.getAttribute("washingMachine");
%>
...
<section id="2">	
	...
	<div id="invisible" style="display:none;">
		<div id="advanceFeatures" style="width:100%;">
			<form method="post" enctype="multipart/form-data" id="form15"> 
				...
				<h3>Advance Features</h3>
					<div class="row">					
						...
						<label> Capacity </label>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="capacity" class="form-control" required placeholder="6.5 kg" /></div>
							<% } else { %>
							<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="capacity" class="form-control" required value="<%=washingMachine.getCapacity() %>" />
							</div>
							<% } %>

						<div class="col-md-3 col-sm-6 col-xs-12">
						<label> In-built Heater </label>
						</div>
							<% if (washingMachine == null) { %>
							<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="inBuiltHeater" class="form-control" required placeholder="No" />
							</div>
							<% } else { %>
							<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="inBuiltHeater" class="form-control" required value="<%=washingMachine.getInBuiltHeater() %>" />
							</div>
							<% } %>							
					      </div>

<%@page import="ecom.model.product.features.MicrowaveOven"%>
...
<title>Microwave Oven Edit Page</title>
...
<%
	MicrowaveOven microwaveOven = (MicrowaveOven) request.getAttribute("microwaveOven");
%>
...
<section id="2">	
	...
	<div id="invisible" style="display:none;">
		<div id="advanceFeatures" style="width:100%;">
			<form method="post" enctype="multipart/form-data" id="form16"> 
				...
				<h3>Advance Features</h3>
					<div class="row">					
						...
						<label> Type </label>
							...
							<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="type" class="form-control" required placeholder="Solo" /></div>
							<% } else { %>
							<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="type" class="form-control" required value="<%=microwaveOven.getType() %>" />
							</div>
							<% } %>
						...
						<label> Capacity </label>
							...
							<% if (microwaveOven == null) { %>
							<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="capacity" class="form-control" required placeholder="17 L" />
							</div>
							<% } else { %>
							<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="capacity" class="form-control" required value="<%=microwaveOven.getCapacity() %>" />
							</div>
							<% } %>							
					      </div>

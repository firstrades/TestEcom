<%@page import="ecom.model.product.features.Geyser"%>
...
<%
	Geyser geyser = (Geyser) request.getAttribute("geyser");
%>
...
<section id="2">	
	...
	<div id="invisible" style="display:none;">
		<div id="advanceFeatures" style="width:100%;">
			<form method="post" enctype="multipart/form-data" id="form20"> 
				...
				<h3>Advance Features</h3>
					<div class="row">					
						...
						<label> Mount Type </label>
							...
							<% if (geyser == null) { %>
							<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="mountType" class="form-control" required placeholder="Vertical" /></div>
							<% } else { %>
							<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="mountType" class="form-control" required value="<%=geyser.getMountType() %>" />
							</div>
							<% } %>
						...
						<label> Capacity </label>
							...
							<% if (geyser == null) { %>
							<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="capacity" class="form-control" required placeholder="1 L" />
							</div>
							<% } else { %>
							<div class="col-md-3 col-sm-6 col-xs-12">
							<input type="text" name="capacity" class="form-control" required value="<%=geyser.getCapacity() %>" />
							</div>
							<% } %>							
					      </div>

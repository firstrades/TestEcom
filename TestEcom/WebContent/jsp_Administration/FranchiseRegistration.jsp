...
<div class="register_pannel">
		...
		<div class="register_page">
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<select name="category" id="category" class="form-control" data-ng-model="sex">
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<input type="text" name="product" class="form-control" placeholder="Enter Last Name"  data-ng-model="mobile2" />
				</div>
			</div>	
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<input type="text" name="product" class="form-control" placeholder="Enter E-mail Id2"  data-ng-model="email2" />
				</div>
			</div>	
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<input type="text" name="company" class="form-control" placeholder="Enter Phone Number1" data-ng-model="phone1" />
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12">
					<label>	Phone Number2</label>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12">
					<input type="text" name="product" class="form-control" placeholder="Enter Phone Number2"  data-ng-model="phone2" />
				</div>
			</div>	
			...
			<div class="row">
				...
				<div class="col-md-3 col-sm-6 col-xs-12">
					<input type="text" name="company" class="form-control" placeholder="Enter Fax  Number1" data-ng-model="fax1" />
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12">
					<label>	Fax No2</label>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12">
					<input type="text" name="product" class="form-control" placeholder="Enter Fax Number2" data-ng-model="fax2" />
				</div>
			</div>			
